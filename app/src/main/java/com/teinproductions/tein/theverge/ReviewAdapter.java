...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.list_item_review, parent, false));
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void parseVergeScore(Element element) {
            ...
            try {
                ...
                Element scoreDiv = element.getElementsByAttributeValue("itemprop", "reviewRating").first();
                Element scoreSpan = element.getElementsByAttributeValue("itemprop", "reviewRating").first();
        ...
        private void setRatio() {
            ...
            imageView.getLayoutParams().height = image.getWidth() / 16 * 9;
